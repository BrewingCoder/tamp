...
/// <summary>
/// Structural JSON equality for tests. SBOM is a JSON document format, so
/// the round-trip contract is "same JSON" — record equality would treat
/// IReadOnlyList&lt;T&gt; as reference equality which is the wrong invariant.
/// </summary>
